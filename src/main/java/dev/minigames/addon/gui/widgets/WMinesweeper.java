                ...
                if (module.gameSounds.get()) {
                    mc.getSoundManager().play(
                        PositionedSoundInstance.master(
                            ...
                            ThreadLocalRandom.current().nextFloat(0.77f, 1.1337f), module.soundVolume.get().floatValue()
                        )
                    );
                    mc.getSoundManager().play(
                        PositionedSoundInstance.master(
        ...
        if (checkWin()) {
            ...
            mc.getSoundManager().play(
                PositionedSoundInstance.master(
                    ...
                    ThreadLocalRandom.current().nextFloat(0.666f, 1.420f), module.soundVolume.get().floatValue()
                )
            );
        }
    }
